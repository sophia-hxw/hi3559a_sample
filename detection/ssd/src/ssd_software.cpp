    ...
    HI_U32 u32backgroundLabelId)
{
    ...
    for (HI_U32 i = 0, u32SrcIdx = 0; i < u32BottomSize; i++) // u32BottomSize, the number of CONCAT
    {
        ...
        for (HI_U32 j = 0; j < u32NumPredsPerClass; j++)
        {
            ...
            HI_FLOAT f32PriorWidth   = (af32PriorBox[2] - af32PriorBox[0]);
            HI_FLOAT f32PriorHeight  = (af32PriorBox[3] - af32PriorBox[1]);
            HI_FLOAT f32PriorCenterX = (af32PriorBox[2] + af32PriorBox[0]) * 0.5f;
            HI_FLOAT f32PriorCenterY = (af32PriorBox[3] + af32PriorBox[1]) * 0.5f;
            ...
            s32AllDecodeBoxes[u32SrcIdx++] = (HI_S32)((f32DecodeBoxCenterX - f32DecodeBoxWidth  * 0.5f) * SVP_WK_QUANT_BASE);
            s32AllDecodeBoxes[u32SrcIdx++] = (HI_S32)((f32DecodeBoxCenterY - f32DecodeBoxHeight * 0.5f) * SVP_WK_QUANT_BASE);
            s32AllDecodeBoxes[u32SrcIdx++] = (HI_S32)((f32DecodeBoxCenterX + f32DecodeBoxWidth  * 0.5f) * SVP_WK_QUANT_BASE);
            s32AllDecodeBoxes[u32SrcIdx++] = (HI_S32)((f32DecodeBoxCenterY + f32DecodeBoxHeight * 0.5f) * SVP_WK_QUANT_BASE);
        } // end of class loop
    } // end of CONCAT
